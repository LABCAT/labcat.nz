  ...
  Document: ({
    ...
    <Html lang="en-US">
      <Head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `document.fonts.ready.then(function () {
